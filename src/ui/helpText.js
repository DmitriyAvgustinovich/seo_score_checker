...
const HELP_TEXTS = {
  ...
  "canonical matches current url": "Whether the canonical URL points to this page after URL normalization, ignoring hashes and known tracking parameters. A different canonical may be intentional for duplicate pages.",
  "canonical points to current url": "Whether the canonical URL points to this page after URL normalization, ignoring hashes and known tracking parameters. A different canonical may be intentional for duplicate pages.",
